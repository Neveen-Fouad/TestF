...
export function mountSidebar(active = "") {
  ...
  const links = [["Dashboard", "/pages/dashboard.html"], ["My trips", "/pages/trips.html"], ["Trip album", "/pages/album.html"], ["Favorites", "/pages/favourites.html"], ["Bookings", "/pages/bookings.html"], ["Notifications", "/pages/notifications.html"], ["Profile", "/pages/profile.html"]];
